...
export default function Calculate() {
  ...
  const [ssdSellCost, setSsdSellCost] = useState(10);
  const [bssdSellCost, setBssdSellCost] = useState(50);

  const [sscSellCost, setSscSellCost] = useState(17);
  const [bsscSellCost, setBsscSellCost] = useState(100);

  const [ssbSellCost, setSsbSellCost] = useState(55);
  const [bssbSellCost, setBssbSellCost] = useState(420);
  ...
  const [cxCost, setCxCost] = useState(0);
  const [bxCost, setBxCost] = useState(0);
